	...
	//---begin---------??????????tree?¨¢??¡À¨ªsno
		 ...
		 /* var deletedataorgaPeoples2people =   ",";
		  ...
		  var querydataorgaPeoples2people =  new Array();
		  ...
		  var oddstyle='';
		  var modelorgaPeoples2people = new dojox.grid.data.Table(null, querydataorgaPeoples2people);
		...
		var getVOorgaPeoples2peoplePeoples=function(id){
			...
			modelorgaPeoples2people.setData(querydataorgaPeoples2peoplePeoples);
		...
		if(mainID!=undefined && mainID!=''){
			...
			if(gridorga2orgaPeoples==undefined){
				gridorga2orgaPeoples = new dojox.Grid({
							...
							structure: layoutorgaPeoples2people,
							rowCount:querydataorgaPeoples2peoplePeoples.length,
							model:modelorgaPeoples2people
						}, dojo.byId("gridorga2orgaPeoples"));
						
				//gridorga2orgaPeoples.resize({ h: dijit.byId("bottomPane").domNode.clientHeight-90});
			}else{
	...
	/*function pageSizeChangeorga2orgaPeoples(mylabel){
		...
		var getChoiseorgaPeoples2people= function(inRowIndex) {
			if(true==querydataorgaPeoples2peoplePeoples[inRowIndex][0]){//'+querydataorgaPeoples2peoplePeoples[inRowIndex][1]+'
				 return  '<input class="dojoxGrid-input"  name="selectorgaPeoples2people" id="" checked="true" type="checkbox" onClick="clickorgaPeoples2people('+inRowIndex+')" />';
			 }else{
				 return  '<input class="dojoxGrid-input"  name="selectorgaPeoples2people" id=""  type="checkbox" onClick="clickorgaPeoples2people('+inRowIndex+')" />';
			 }
		}
