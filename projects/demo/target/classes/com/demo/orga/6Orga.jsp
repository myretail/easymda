...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
			...
			dojoOrgaPeoples.initOrgaPeoples();
 			...
 			<script type="text/javascript" src="../orga/orga2orgaPeoplesRightCrudAFTab.js"></script>
	  	<script type="text/javascript" >
...
var handle ;
function gridResize(){
			if(gridorga2orgaPeoples!=undefined)gridorga2orgaPeoples.resize({w: dijit.byId("rightPane").domNode.clientWidth-16,h:dijit.byId("rightPane").domNode.clientHeight-100});
	 		gridOrga.resize({w:document.body.clientWidth-dijit.byId("rightPane").domNode.clientWidth-36});
}
function init(){
...
setTimeout(function(){
	gridOrga.resize({w: document.body.clientWidth-60,h: document.body.clientHeight-40});
