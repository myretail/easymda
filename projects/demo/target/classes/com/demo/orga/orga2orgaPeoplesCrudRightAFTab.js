...
//end--????"????¡À¨ª" ?? "????¡À¨ª"??????¡Á?¡À¨ª	
	...
	var buildorga2orgaPeoples=function(){
		if(NUorga2orgaPeoples && mainID!=undefined && mainID!=''){
			...
			if(gridorga2orgaPeoples==undefined){//+dijit.byId("?
...
function clickorgaPeoples2people(row){//  
			...
			if(querydataorgaPeoples2peoplePeoples[row][querydataorgaPeoples2peoplePeoples[row].length-1]==undefined||querydataorgaPeoples2peoplePeoples[row][querydataorgaPeoples2peoplePeoples[row].length-1]==''){
