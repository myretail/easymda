...
var buildcontacts2customer=function(mainID){
	if( mainID!=undefined && mainID!=''){//NUcontacts2customer &&
	    var openFloat=dijit.byId("gridcontacts2customer"+mainID);
		if(openFloat==undefined){
			contacts2customerFloatArray[mainID] = new contacts2customerFloatPara(mainID);
			var newTab = dijit.byId("contacts2customer"+mainID);
			newTab.setContent("<table   style=\"width:80%; position:absolute;top:0px;\"><tr height=\"25px\" width=\"100%\">	<td align=\"left\" style=\"background:transparent\"><img src="../image/imgTitle.jpg" class="imgTitleStyle" ><b>   contacts2customer List&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td align=\"right\" ><span ></span>&nbsp;&nbsp;	<div > </div><div > </div><div > </div>	<div > </div><div > </div>	</td></tr></table><div style=\"{width:500px;height:500px; position:absolute;top:30px;}\" ><div > </div></div>");
	...
	var but5 = new dijit.form.Button({label:"save",iconClass:"saveIcon",id:"but3contacts2customer"+mainID },openContainerTable[5]);//,onclick:but3contacts2customer(mainID)
		...
		//if(contacts2customerFloatArray[mainID].gridcontacts2customer==""){
			  contacts2customerFloatArray[mainID].gridcontacts2customer = new dojox.Grid({
				...
				contacts2customerFloatArray[mainID].gridcontacts2customer.resize({w:999,h:500});
		}else{
			getVOcontacts2customer(contacts2customerFloatArray[mainID].queryvocontacts2customer,mainID);
			contacts2customerFloatArray[mainID].gridcontacts2customer.modelAllChange();
