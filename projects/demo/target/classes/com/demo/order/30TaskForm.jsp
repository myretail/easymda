...
function init(){
  ...
  setTimeout(function(){
	gridTaskForm.resize({h: dojo.byId("gridTaskForm").parentNode.clientHeight-36});
 ...
 dojo.addOnLoad(init);   
function gridResize(){
	TaskFormSelectTab.resize({h: dijit.byId("bottomPane").domNode.clientHeight-40});
	if(dijit.byId("gridpane"+dijit.byId("TaskFormSelectTab").selectedChildWidget.id)!=undefined)dijit.byId("gridpane"+dijit.byId("TaskFormSelectTab").selectedChildWidget.id).resize({h: dijit.byId("bottomPane").domNode.clientHeight-90});
	/*								if(dijit.byId("gridpanecar2taskForms")!=undefined)dijit.byId("gridpanecar2taskForms").resize({h: dijit.byId("bottomPane").domNode.clientHeight-90});
													*/
