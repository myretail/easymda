...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
 			...
 			<script type="text/javascript" src="../order/order2orderRowRightCrudAFTab.js"></script>
...
var handle ;
function gridResize(){
			if(gridorder2orderRow!=undefined)gridorder2orderRow.resize({w: dijit.byId("rightPane").domNode.clientWidth-16,h:dijit.byId("rightPane").domNode.clientHeight-100});
	 	 		gridOrderd.resize({w:document.body.clientWidth-dijit.byId("rightPane").domNode.clientWidth-36});
}
function init(){
...
setTimeout(function(){
	gridOrderd.resize({w: document.body.clientWidth-60,h: document.body.clientHeight-40});
