...
//set (= taskForm2tasks)
	//name =taskForm2tasksAFTab.js  manageable.name=TaskForm
...
//----------move from 30.1 begin-----------
										                  ...
										                  // totleinum = 4 
	var layouttaskForm2tasks =[{//???????????¡À??????colSpantoggle
	...
	//
							//
							 ,   {name: i18nStr.car,field: 6,get:function(inRowIndex){ var str='';var strid;if(querydatataskForm2tasks[inRowIndex]!=undefined && querydatataskForm2tasks[inRowIndex][6]!=undefined && querydatataskForm2tasks[inRowIndex][6][1]!=undefined){str=querydatataskForm2tasks[inRowIndex][6][2];strid=querydatataskForm2tasks[inRowIndex][6][1];} return str;} ,width: 10 }
								],[
...
function getDetailTaskForm(inRowIndex){
	if(detailRowsTaskForm[inRowIndex]){
		...
		var h =0;
		if(detailRowsTaskForm[inRowIndex]&&querydatataskForm2tasks[inRowIndex][5].length>0){
							h=65+25*querydatataskForm2tasks[inRowIndex][5].length;  		}
...
function buildSubgridtaskForm2tasks(inRowIndex, inCell) {  //makeSubgridIdMainDetail(id)?idmainDetailGridid
	if(inCell!=undefined && inCell.getNode(inRowIndex)!=undefined){
		...
		var dataChild=querydatataskForm2tasks[inRowIndex][5];
...
function saveSubRow(subGrid,thisCell,i){		 
	     ...
	     vobject.id=thisCell[1];
			...
			mainTable.id=querydatataskForm2tasks[subGrid.dataRow][1];
