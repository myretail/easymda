...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
 			...
 			<script type="text/javascript" src="../order/taskForm2tasksRightCrudAFTab.js"></script>
	 	  			<script type="text/javascript" src="tasks.js"></script><!--sub Table script    eg:taskRow.js    ??????¨ª???????¡ÀchildRow=0-->
			<script type="text/javascript" >
...
var handle ;
function gridResize(){
			if(gridtaskForm2tasks!=undefined)gridtaskForm2tasks.resize({w: dijit.byId("rightPane").domNode.clientWidth-16,h:dijit.byId("rightPane").domNode.clientHeight-100});
	 	 		gridTaskForm.resize({w:document.body.clientWidth-dijit.byId("rightPane").domNode.clientWidth-36});
}
function init(){
...
setTimeout(function(){
	gridTaskForm.resize({w: document.body.clientWidth-60,h: document.body.clientHeight-40});
...
<table  width="100%">
	...
	<tr height="25px" width="100%">
							...
							<td align="left"><img src="../image/imgTitle.jpg" class="imgTitleStyle" ><b>   taskForm2tasks List</b></td>
			<td align="right" >
						...
						<button dojoType="dijit.form.myButton" onclick="downPagetaskForm2tasks();" id="but7taskForm2tasks" disabled='true' jsId="but7taskForm2tasks" iconClass="downPageIcon" >pagedown</button>
																																																																																			<button dojoType="dijit.form.Button" onclick="addRowtaskForm2tasks();" iconClass="addIcon" >add</button>
					<button dojoType="dijit.form.Button" onclick="removetaskForm2tasks();" iconClass="delIcon" >delete</button>
					<button dojoType="dijit.form.Button" id="but3taskForm2tasks" jsId="but3taskForm2tasks" onclick="call_funUpdtaskForm2tasks();"  iconClass="saveIcon">save</button>
								</td>
		</tr>
	</table>			
