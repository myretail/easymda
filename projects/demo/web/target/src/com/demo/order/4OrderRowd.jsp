...
<title></title>
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 	 	 			...
 	 	 			<script type="text/javascript" src="../order/orderRow2orderRowTasksCrudAFTab.js"></script>
	 			<script type="text/javascript" src="../order/payment2paymentsCrudAFTab.js"></script>
	...
	clickRowTab();
		...
		if(connecthandle==0){
			handle=dojo.connect(dijit.byId("gridOrderRowd"), "doclick", function(e){
				...
				mainName = querydataOrderRowd[e.rowIndex][2];
				resetNU();
				clickRowTab();		
			});
			connecthandle=1;
