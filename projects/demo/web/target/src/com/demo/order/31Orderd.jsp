	...
	//
		  ...
		  //(17 > 10)
			//delete2
				...
				{ name: '\u8be6\u7ec6', colSpan: 10 ,styles: 'padding: 0; margin: 0;', get: getDetailOrderd }//value: '<div style="height:0px; background-color: white;"></div>'
			  ]*/
		  ]
...
<div dojoType="dojox.layout.ExpandoPane" splitter="true" duration="125" region="bottom" title="" style="height:375px;"  onLoad="myOnLoad" id="bottomPane" jsId="bottomPane" ><!--href="OrderdSelectTab.html"-->
		...
		<td align="right" >
					...
					<button dojoType="dijit.form.myButton" onclick="downPagepanecustomer2orderds();" id="but7panecustomer2orderds" disabled='true' jsId="but7panecustomer2orderds" iconClass="downPageIcon" >pagedown</button>
							...
							<div dojoType="dojox.layout.ContentPane" href="../common/customer2orderdsSelectPane.html"  >  </div>
	</div>
