...
function getDetailOrderd(inRowIndex){
	if(detailRowsOrderd[inRowIndex]){
		...
		var h =0;
		if(detailRowsOrderd[inRowIndex]&&querydatacustomer2orderds[inRowIndex][16].length>0){
							h=65+25*querydatacustomer2orderds[inRowIndex][16].length;  		}
...
function buildSubgridcustomer2orderds(inRowIndex, inCell) {  //makeSubgridIdMainDetail(id)?idmainDetailGridid
	if(inCell!=undefined && inCell.getNode(inRowIndex)!=undefined){
		...
		var dataChild=querydatacustomer2orderds[inRowIndex][16];
