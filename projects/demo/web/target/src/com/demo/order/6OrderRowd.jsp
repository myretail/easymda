	...
	<script type="text/javascript" >
	    ...
	    dojoOrderRowd.initOrderRowd();
			...
			dojoPayment.initPayment();
 	 	 			...
 	 	 			<script type="text/javascript" src="../order/orderRow2orderRowTasksRightCrudAFTab.js"></script>
	 			<script type="text/javascript" src="../order/payment2paymentsRightCrudAFTab.js"></script>
	  			<script type="text/javascript" >
...
var handle ;
function gridResize(){
	OrderRowdAFTab.resize({w: dijit.byId("rightPane").domNode.clientWidth-10,h: document.body.clientHeight-40});
	 	 			if(gridorderRow2orderRowTasks!=undefined)gridorderRow2orderRowTasks.resize({w: dijit.byId("rightPane").domNode.clientWidth-16,h:dijit.byId("rightPane").domNode.clientHeight-100});
	 			if(gridpayment2payments!=undefined)gridpayment2payments.resize({w: dijit.byId("rightPane").domNode.clientWidth-16,h:dijit.byId("rightPane").domNode.clientHeight-100});
	 		gridOrderRowd.resize({w:document.body.clientWidth-dijit.byId("rightPane").domNode.clientWidth-36});
}
function init(){
...
setTimeout(function(){
	gridOrderRowd.resize({w: document.body.clientWidth-60,h: document.body.clientHeight-40});
		dojo.connect(dijit.byId("OrderRowdAFTab"), "selectChild", function(e){
...
<table  width="100%">
	<tr height="25px" width="100%">
		...
		<div dojoType="dojox.layout.ExpandoPane" splitter="true" duration="125" region="left" title="" style="width:400px;" id="rightPane" jsId="rightPane" >
														<table id="orderRow2orderRowTasksTable"  style=" position:absolute;top:30px; width:90%; visibility:visible ">
				<tr height="25px" width="100%">
		<td align="right" >
					...
					<button dojoType="dijit.form.myButton" onclick="downPageorderRow2orderRowTasks();" id="but7orderRow2orderRowTasks" disabled='true' jsId="but7orderRow2orderRowTasks" iconClass="downPageIcon" >pagedown</button>
									...
									<table id="payment2paymentsTable"  style=" position:absolute;top:30px; width:90%; visibility:hidden ">		
				<tr height="25px" width="100%">
		<td align="right" >
				...
				<div dojoType="dijit.layout.TabContainer" style="height:100%; width:100%;position:absolute;top:30px;"   id="OrderRowdAFTab" jsId="OrderRowdAFTab"  >
