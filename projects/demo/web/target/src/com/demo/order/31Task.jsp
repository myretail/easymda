...
//have set function's manageableAssociationEnds
	...
	//
				...
				{ name: '\u8be6\u7ec6', colSpan: 6 ,styles: 'padding: 0; margin: 0;', get: getDetailTask }//value: '<div style="height:0px; background-color: white;"></div>'
			  ]*/
		  ]
...
var addrow=[];
														addrow.push('');
																					addrow.push('');
																					addrow.push('');
																							if(ifMultPanetaskForm2tasks!=undefined){
					var re=selecttaskForm2tasksFunClick();
					addrow.push(re);}
						addrow.splice(0,0,false,0);
	gridTask.addRow(addrow,gridTask.model.getRowCount());
} 
       ...
       if(sall[i][0]==true){
         ...
         vobject.id=thisCell[1];
			...
			var manageable=new Object();
			 if(querydataTask[i][5]!=''&&querydataTask[i][5]!=undefined){
             manageable.id=querydataTask[i][5][1];
             vobject.taskForm=manageable;
			 }else{
			 gridTask.getCell(gridTask.model.fieldArray[5]).getNode(i).innerHTML="<span style={color:red;line-height:16px}>can not be null</span>"; passAll=1;
			 }
...
//
					...
					<td align="left" ><input  id="queryTasktaskForm"  jsId="queryTasktaskForm" class="editerInput" dojoType="dijit.form.myFilteringSelect" store="dojoTask.taskFormStore"  /></td>  
						    </tr>
...
<div dojoType="dojox.layout.ExpandoPane" splitter="true" duration="125" region="bottom" title="" style="height:375px;"  onLoad="myOnLoad" id="bottomPane" jsId="bottomPane" ><!--href="TaskSelectTab.html"-->
								<table id="taskForm2tasksTable"  style=" position:absolute;top:0px; width:90%; visibility:visible ">
				<tr height="25px" width="100%">
		<td align="right" >
					<span id="rowCountpanetaskForm2tasks"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button dojoType="dijit.form.myButton" onclick="upPagepanetaskForm2tasks();"  id="but6panetaskForm2tasks" disabled='true' jsId="but6panetaskForm2tasks" iconClass="upPageIcon" >pageup</button>
					<button dojoType="dijit.form.myButton" onclick="downPagepanetaskForm2tasks();" id="but7panetaskForm2tasks" disabled='true' jsId="but7panetaskForm2tasks" iconClass="downPageIcon" >pagedown</button>
	</td></tr></table>
						<div dojoType="dojox.layout.ContentPane" href="../common/taskForm2tasksSelectPane.html"  >  </div>
	</div>
