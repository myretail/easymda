...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 			...
 			<script type="text/javascript" src="../basic/principal2prodsCrudAFTab.js"></script>
	 			<script type="text/javascript" src="../orga/orgaPeoples2peopleCrudAFTab.js"></script>
	...
	clickRowTab();
		...
		if(connecthandle==0){
			handle=dojo.connect(dijit.byId("gridPeoples"), "doclick", function(e){
				...
				mainName = querydataPeoples[e.rowIndex][2];
				resetNU();
				clickRowTab();		
			});
			connecthandle=1;
