...
setTimeout(function(){
	...
	dojo.connect(dijit.byId("topPane"), "_afterResize", function(e){dijit.byId("gridOrga").resize({w:dojo.byId("gridOrga").parentNode.clientWidth,h: dojo.byId("gridOrga").parentNode.clientHeight-40});}); 
	dojo.connect(dijit.byId("OrgaCrud"), "resize", function(e){dijit.byId("gridOrga").resize({w:dojo.byId("gridOrga").parentNode.clientWidth,h: dojo.byId("gridOrga").parentNode.clientHeight-40});}); 
...
<div id="tree" showRoot="true" persist="false" dojoType="dijit.Tree"  store="popStore" labelAttr="name"  childrenAttr="children"  model="treeModel" ></div> 
		...
		<div dojoType="dijit.layout.ContentPane" title="Orga"  id="OrgaCrud" jsId="OrgaCrud" region="center"  >
