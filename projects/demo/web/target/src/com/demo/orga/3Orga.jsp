...
<title></title>
	...
	//å¤æ­æ¯å¦æ¯ä¸»è¡¨		
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 			...
 			<script type="text/javascript" src="../orga/orga2orgaPeoplesAFTab.js"></script><!--org.andromda.cartridges.bpm4struts.metafacades.StrutsManageableEntityLogicImpl[OrgaPeoples]-->
