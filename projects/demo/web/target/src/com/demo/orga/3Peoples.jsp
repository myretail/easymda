...
<title></title>
	...
	//å¤æ­æ¯å¦æ¯ä¸»è¡¨		
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 			...
 			<script type="text/javascript" src="../basic/principal2prodsAFTab.js"></script><!--org.andromda.cartridges.bpm4struts.metafacades.StrutsManageableEntityLogicImpl[Prod]-->
	 			<script type="text/javascript" src="../orga/orgaPeoples2peopleAFTab.js"></script><!--org.andromda.cartridges.bpm4struts.metafacades.StrutsManageableEntityLogicImpl[OrgaPeoples]-->
...
var handle ;
function gridResize(){
PeoplesAFTab.resize({t:8,h: dijit.byId("bottomPane").domNode.clientHeight-40});
			if(gridprincipal2prods!=undefined)gridprincipal2prods.resize({h: dijit.byId("bottomPane").domNode.clientHeight-90});
	 			if(gridorgaPeoples2people!=undefined)gridorgaPeoples2people.resize({h: dijit.byId("bottomPane").domNode.clientHeight-90});
	 		gridPeoples.resize({h:document.body.clientHeight-dijit.byId("bottomPane").domNode.clientHeight-36});
}		
function init(){
...
setTimeout(function(){
	gridPeoples.resize({h: document.body.clientHeight-86});
		dojo.connect(dijit.byId("PeoplesAFTab"), "selectChild", function(e){
...
<table  width="100%">
	<tr height="25px" width="100%">
       ...
       <div id="gridPeoples"  dojoType="dojox.Grid" autoWidth="false"  jsId="gridPeoples"	model="modelPeoples"  structure="layoutSingleRowQuery"  ></div>
    </div>  
	<div dojoType="dojox.layout.ExpandoPane" splitter="true" duration="125" region="bottom" title="relative data" style="height:375px;" id="bottomPane" jsId="bottomPane" >
								<table id="principal2prodsTable"  style=" position:absolute;top:0px;left:500px; width:50%; visibility:visible;z-index:9000 ">
				<tr height="25px" width="100%">
	<!--td align="left"><img src="../image/imgTitle.jpg" class="imgTitleStyle" ><b>   principal2prods List</b></td-->
		<td align="right" >
					...
					<button dojoType="dijit.form.myButton" onclick="downPageprincipal2prods();" id="but7principal2prods" disabled='true' jsId="but7principal2prods" iconClass="downPageIcon" >pagedown</button>
									...
									<table id="orgaPeoples2peopleTable"  style=" position:absolute;top:0px;left:500px; width:50%; visibility:hidden ;z-index:9000">		
				<tr height="25px" width="100%">
	<!--td align="left"><img src="../image/imgTitle.jpg" class="imgTitleStyle" ><b>   orgaPeoples2people List</b></td-->
		<td align="right" >
				...
				<div dojoType="dijit.layout.TabContainer" style="height:100%;width:99%; position:absolute;top:8px;"   id="PeoplesAFTab" jsId="PeoplesAFTab"  >
