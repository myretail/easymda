...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 					...
 					<script type="text/javascript" src="../basic/prodCust2prodsFloatAFTab_n.js"></script>
		
	 					<script type="text/javascript" src="../basic/contacts2customerFloatAFTab_n.js"></script>
		
	 					<script type="text/javascript" src="../order/customer2orderdsFloatAFTab_n.js"></script>
...
function openFloat(indexRow,e){
	...
	if(openFloat==undefined){
		...
		var fp = new dojox.layout.FloatingPane({
			...
			dockable:true//,
			//onLoad:onloadmy,
			//href:"CustomerQueryAFFloat.html"
		},div);
...
function querybutton(){
              ...
              queryvoCustomer=new Object();
								  if(querycustomerName.getDisplayedValue()!="")queryvoCustomer.customerName=querycustomerName.getDisplayedValue();//
											  if(querycustEnum.getDisplayedValue()!="")queryvoCustomer.custEnum=querycustEnum.getDisplayedValue();//
	...
	<td style="{width:22%}"></td></tr>  
                <tr>
						...
						<td align="left"  colspan="3" >
												<input  id="querycustEnum" jsId="querycustEnum" class="editerInput"  dojoType="dijit.form.FilteringSelect" store="dojoCustomer.custEnumStore" />
												</td>  
