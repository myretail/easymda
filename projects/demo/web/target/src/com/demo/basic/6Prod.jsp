	...
	<script type="text/javascript" >
	    ...
	    dojoProd.initProd();
			...
			dojoOrderRowd.initOrderRowd();
 	 	 			...
 	 	 			<script type="text/javascript" src="../order/orderRowds2productRightCrudAFTab.js"></script>
	  			<script type="text/javascript" >
...
var handle ;
function gridResize(){
	 	 			if(gridorderRowds2product!=undefined)gridorderRowds2product.resize({w: dijit.byId("rightPane").domNode.clientWidth-16,h:dijit.byId("rightPane").domNode.clientHeight-100});
	 		gridProd.resize({w:document.body.clientWidth-dijit.byId("rightPane").domNode.clientWidth-36});
}
function init(){
...
setTimeout(function(){
	gridProd.resize({w: document.body.clientWidth-60,h: document.body.clientHeight-40});
