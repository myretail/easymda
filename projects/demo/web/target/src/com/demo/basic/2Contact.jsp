  ...
  <table align="center" width=100% class="queryTable"  >
	...
	<td style="{width:22%}"></td></tr>  
                <tr>
					...
					<td align="left" colspan="3"  ><!----><input  id="querycustomer"  jsId="querycustomer" class="selectInput" dojoType="dijit.form.myFilteringSelect" store="dojoContact.customerStore"  /><div dojoType="dijit.form.myDropDownButton" iconClass="dialogIcon"  ><div dojoType="dijit.TooltipDialog"  href="../common/queryCustomerFloat.html"title="detail" execute="" ></div></div></td>  
