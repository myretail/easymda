...
var buildprodCust2prods=function(mainID){
	if( mainID!=undefined && mainID!=''){//NUprodCust2prods &&
	    var openFloat=dijit.byId("gridprodCust2prods"+mainID);
		if(openFloat==undefined){
			prodCust2prodsFloatArray[mainID] = new prodCust2prodsFloatPara(mainID);
			var newTab = dijit.byId("prodCust2prods"+mainID);
			newTab.setContent("<table   style=\"width:80%; position:absolute;top:0px;\"><tr height=\"25px\" width=\"100%\">	<td align=\"left\" style=\"background:transparent\"><img src="../image/imgTitle.jpg" class="imgTitleStyle" ><b>   prodCust2prods List&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td align=\"right\" ><span ></span>&nbsp;&nbsp;	<div > </div><div > </div><div > </div>	<div > </div><div > </div>	</td></tr></table><div style=\"{width:500px;height:500px; position:absolute;top:30px;}\" ><div > </div></div>");
	...
	var but5 = new dijit.form.Button({label:"save",iconClass:"saveIcon",id:"but3prodCust2prods"+mainID },openContainerTable[5]);//,onclick:but3prodCust2prods(mainID)
		...
		//if(prodCust2prodsFloatArray[mainID].gridprodCust2prods==""){
			  prodCust2prodsFloatArray[mainID].gridprodCust2prods = new dojox.Grid({
				...
				prodCust2prodsFloatArray[mainID].gridprodCust2prods.resize({w:999,h:500});
		}else{
			getVOprodCust2prods(prodCust2prodsFloatArray[mainID].queryvoprodCust2prods,mainID);
			prodCust2prodsFloatArray[mainID].gridprodCust2prods.modelAllChange();
