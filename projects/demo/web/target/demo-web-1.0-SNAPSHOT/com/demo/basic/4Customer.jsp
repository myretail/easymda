...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 			...
 			<script type="text/javascript" src="../basic/prodCust2prodsCrudAFTab.js"></script>
	 			<script type="text/javascript" src="../basic/contacts2customerCrudAFTab.js"></script>
	 			<script type="text/javascript" src="../order/customer2orderdsCrudAFTab.js"></script>
	...
	clickRowTab();
		...
		if(connecthandle==0){
			handle=dojo.connect(dijit.byId("gridCustomer"), "doclick", function(e){
				...
				mainName = querydataCustomer[e.rowIndex][2];
				resetNU();
				clickRowTab();		
			});
			connecthandle=1;
