...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
			...
			dojoOrgaPeoples.initOrgaPeoples();
 			...
 			<script type="text/javascript" src="../orga/orga2orgaPeoplesTreeRightCrudAFTab3.js"></script>
	  	<script type="text/javascript" >
...
<table  style="width:90%;">		
	<tr height="25px" width="100%">
		...
		<td align="right" >
					...
					<button dojoType="dijit.form.Button" onclick="addRoworga2orgaPeoples();" iconClass="addIcon" >add</button>
					<button dojoType="dijit.form.Button" onclick="removeorga2orgaPeoples();" iconClass="delIcon" >delete</button>
					<button dojoType="dijit.form.Button" id="but3orga2orgaPeoples" jsId="but3orga2orgaPeoples" onclick="call_funUpdorga2orgaPeoples();"  iconClass="saveIcon">save</button>
