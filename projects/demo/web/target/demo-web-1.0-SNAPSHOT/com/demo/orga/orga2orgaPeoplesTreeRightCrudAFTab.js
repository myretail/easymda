	...
	var buildorga2orgaPeoples=function(){
		if(NUorga2orgaPeoples && mainID!=undefined && mainID!=''){
			...
			if(gridorga2orgaPeoples==undefined){
				...
				gridorga2orgaPeoples.resize({ w:dojo.byId("gridorga2orgaPeoples").parentNode.clientWidth,h: dojo.byId("gridorga2orgaPeoples").parentNode.clientHeight-40});
			}else{
				gridorga2orgaPeoples.model.setData(querydataorgaPeoples2peoplePeoples);
			}
