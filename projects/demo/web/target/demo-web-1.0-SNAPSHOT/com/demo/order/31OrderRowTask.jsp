...
<title></title>
	 ...
	 <script type="text/javascript" >
	    ...
	    dojoOrderRowTask.initOrderRowTask();
	 		...
	 		<script type="text/javascript" src="OrderRowdSelectPane.js"></script><!--Ò»Òª,Ò»Ô¶Â£Í²Òª-->
	 		<script type="text/javascript" src="TaskSelectPane.js"></script><!--Ò»Òª,Ò»Ô¶Â£Í²Òª-->
	 	 							<script type="text/javascript" >
...
//have set function's manageableAssociationEnds
	...
	//
				...
				{ name: '\u8be6\u7ec6', colSpan: 4 ,styles: 'padding: 0; margin: 0;', get: getDetailOrderRowTask }//value: '<div style="height:0px; background-color: white;"></div>'
			  ]*/
		  ]
...
function init(){
	...
	getOrderRowTaskVO(queryvoOrderRowTask);
		...
		dojo.connect(dijit.byId("OrderRowTaskSelectTab"), "selectChild", function(e){
			dojo.byId("orderRow2orderRowTasksTable").style.visibility="hidden";
				dojo.byId("orderRowTasks2taskTable").style.visibility="hidden";
	dojo.byId(dijit.byId("OrderRowTaskSelectTab").selectedChildWidget.id+"Table").style.visibility="visible";
  });	
}
...
var addrow=[];
																if(ifMultPaneorderRow2orderRowTasks!=undefined){
					var re=selectorderRow2orderRowTasksFunClick();
					addrow.push(re);}
												if(ifMultPaneorderRowTasks2task!=undefined){
					var re=selectorderRowTasks2taskFunClick();
					addrow.push(re);}
						addrow.splice(0,0,false,0);
	gridOrderRowTask.addRow(addrow,gridOrderRowTask.model.getRowCount());
} 
...
//
					...
					<td align="left" ><input  id="queryOrderRowTaskorderRow"  jsId="queryOrderRowTaskorderRow" class="editerInput" dojoType="dijit.form.myFilteringSelect" store="dojoOrderRowTask.orderRowStore"  /></td>  
														<td align="right"  i18n="task"  ></td>
					<td align="left" colspan="3" ><input  id="queryOrderRowTasktask"  jsId="queryOrderRowTasktask" class="editerInput" dojoType="dijit.form.myFilteringSelect" store="dojoOrderRowTask.taskStore"  /></td>  
						    </tr>
...
<div dojoType="dojox.layout.ExpandoPane" splitter="true" duration="125" region="bottom" title="" style="height:375px;"  onLoad="myOnLoad" id="bottomPane" jsId="bottomPane" ><!--href="OrderRowTaskSelectTab.html"-->
								<table id="orderRow2orderRowTasksTable"  style=" position:absolute;top:0px; width:90%; visibility:visible ">
				<tr height="25px" width="100%">
		<td align="right" >
					<span id="rowCountpaneorderRow2orderRowTasks"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button dojoType="dijit.form.myButton" onclick="upPagepaneorderRow2orderRowTasks();"  id="but6paneorderRow2orderRowTasks" disabled='true' jsId="but6paneorderRow2orderRowTasks" iconClass="upPageIcon" >pageup</button>
					<button dojoType="dijit.form.myButton" onclick="downPagepaneorderRow2orderRowTasks();" id="but7paneorderRow2orderRowTasks" disabled='true' jsId="but7paneorderRow2orderRowTasks" iconClass="downPageIcon" >pagedown</button>
	</td></tr></table>
									<table id="orderRowTasks2taskTable"  style=" position:absolute;top:0px; width:90%; visibility:hidden ">		
				<tr height="25px" width="100%">
		<td align="right" >
					<span id="rowCountpaneorderRowTasks2task"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button dojoType="dijit.form.myButton" onclick="upPagepaneorderRowTasks2task();"  id="but6paneorderRowTasks2task" disabled='true' jsId="but6paneorderRowTasks2task" iconClass="upPageIcon" >pageup</button>
					<button dojoType="dijit.form.myButton" onclick="downPagepaneorderRowTasks2task();" id="but7paneorderRowTasks2task" disabled='true' jsId="but7paneorderRowTasks2task" iconClass="downPageIcon" >pagedown</button>
	</td></tr></table>
				<div dojoType="dijit.layout.TabContainer" style="height:100%; width:100%;"   id="OrderRowTaskSelectTab" jsId="OrderRowTaskSelectTab"  >
			<div dojoType="dojox.layout.ContentPane" href="../common/orderRow2orderRowTasksSelectPane.html" title="orderRow"  id="orderRow2orderRowTasks" jsId="orderRowSelectPane" >
		</div>
				<div dojoType="dojox.layout.ContentPane" href="../common/orderRowTasks2taskSelectPane.html" title="task"  id="orderRowTasks2task" jsId="taskSelectPane" >
		</div>
		</div>
</div>
