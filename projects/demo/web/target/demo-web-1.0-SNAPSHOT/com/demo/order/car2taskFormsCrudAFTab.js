			...
			//set (= car2taskForms)
	//name =car2taskFormsCrudAFTab.js  manageable.name=TaskForm
...
//----------move from 30.1 begin-----------
	...
	//
							//
							 ,   {name: i18nStr.car,field: 7,get:function(inRowIndex){ var str='';var strid;if(querydatacar2taskForms[inRowIndex]!=undefined && querydatacar2taskForms[inRowIndex][7]!=undefined && querydatacar2taskForms[inRowIndex][7][1]!=undefined){str=querydatacar2taskForms[inRowIndex][7][2];strid=querydatacar2taskForms[inRowIndex][7][1];} return str+'<img src="../image/selectFloat.gif" height="16" width="16" class="imgSelectStyle"onclick="dojoTaskForm.selectcar('+strid+','+inRowIndex+',7,0,event);"   >';} ,width: 10 }
								],[
...
function getDetailTaskForm(inRowIndex){
	if(detailRowsTaskForm[inRowIndex]){
		...
		var h =0;
		if(detailRowsTaskForm[inRowIndex]&&querydatacar2taskForms[inRowIndex][6].length>0){
							h=65+25*querydatacar2taskForms[inRowIndex][6].length;  		}
...
function buildSubgridcar2taskForms(inRowIndex, inCell) {  //makeSubgridIdMainDetail(id)?idmainDetailGridid
	if(inCell!=undefined && inCell.getNode(inRowIndex)!=undefined){
		...
		var dataChild=querydatacar2taskForms[inRowIndex][6];
