...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 					...
 					<script type="text/javascript" src="../order/taskForm2tasksFloatAFTab.js"></script>
...
function openFloat(indexRow,e){
	...
	if(openFloat==undefined){
		...
		var fp = new dojox.layout.FloatingPane({
			...
			dockable:true//,
			//onLoad:onloadmy,
			//href:"TaskFormQueryAFFloat.html"
		},div);
...
function querybutton(){
              ...
              queryvoTaskForm=new Object();
					  ...
					  if(d==null){validstate=1;}else if(d.upSign!="%"){queryvoTaskForm.setDate=d;}
											  if(queryformState.getDisplayedValue()!="")queryvoTaskForm.formState=queryformState.getDisplayedValue();//
											  if(queryremark.getDisplayedValue()!="")queryvoTaskForm.remark=queryremark.getDisplayedValue();//
							
	if(querytasks.getDisplayedValue()!=""){
				var tasksQuery= new Object();
				//tasksQuery.Name=querytasks.getDisplayedValue();
				tasksQuery.id=querytasks.getValue();
				queryvoTaskForm.tasks=tasksQuery;
			  }
	if(querycar.getDisplayedValue()!=""){
				var carQuery= new Object();
				//carQuery.Name=querycar.getDisplayedValue();
