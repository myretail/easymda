...
var buildcar2taskForms=function(mainID){
	if( mainID!=undefined && mainID!=''){//NUcar2taskForms &&
	    var openFloat=dijit.byId("gridcar2taskForms"+mainID);
		if(openFloat==undefined){
			car2taskFormsFloatArray[mainID] = new car2taskFormsFloatPara(mainID);
			var newTab = dijit.byId("car2taskForms"+mainID);
			newTab.setContent("<table   style=\"width:80%; position:absolute;top:0px;\"><tr height=\"25px\" width=\"100%\">	<td align=\"left\" style=\"background:transparent\"><img src="../image/imgTitle.jpg" class="imgTitleStyle" ><b>   car2taskForms List&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td align=\"right\" ><span ></span>&nbsp;&nbsp;	<div > </div><div > </div><div > </div>	<div > </div><div > </div>	</td></tr></table><div style=\"{width:500px;height:500px; position:absolute;top:30px;}\" ><div > </div></div>");
	...
	var but5 = new dijit.form.Button({label:"save",iconClass:"saveIcon",id:"but3car2taskForms"+mainID },openContainerTable[5]);//,onclick:but3car2taskForms(mainID)
		...
		//if(car2taskFormsFloatArray[mainID].gridcar2taskForms==""){
			  car2taskFormsFloatArray[mainID].gridcar2taskForms = new dojox.Grid({
				...
				car2taskFormsFloatArray[mainID].gridcar2taskForms.resize({w:999,h:500});
		}else{
			getVOcar2taskForms(car2taskFormsFloatArray[mainID].queryvocar2taskForms,mainID);
			car2taskFormsFloatArray[mainID].gridcar2taskForms.modelAllChange();
