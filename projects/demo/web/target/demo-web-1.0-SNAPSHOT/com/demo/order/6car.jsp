...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
			...
			dojoTaskForm.initTaskForm();
 			...
 			<script type="text/javascript" src="../order/car2taskFormsRightCrudAFTab.js"></script>
	  	<script type="text/javascript" >
...
var handle ;
function gridResize(){
			if(gridcar2taskForms!=undefined)gridcar2taskForms.resize({w: dijit.byId("rightPane").domNode.clientWidth-16,h:dijit.byId("rightPane").domNode.clientHeight-100});
	 		gridcar.resize({w:document.body.clientWidth-dijit.byId("rightPane").domNode.clientWidth-36});
}
function init(){
  getVOcar(queryvocar);
...
setTimeout(function(){
	gridcar.resize({w: document.body.clientWidth-60,h: document.body.clientHeight-40});
	...
	<tr height="25px" width="100%">
			...
			<td align="right" >
						...
						<button dojoType="dijit.form.myButton" onclick="downPagecar2taskForms();" id="but7car2taskForms" disabled='true' jsId="but7car2taskForms" iconClass="downPageIcon" >pagedown</button>
																																																																																			<button dojoType="dijit.form.Button" onclick="addRowcar2taskForms();" iconClass="addIcon" >add</button>
					<button dojoType="dijit.form.Button" onclick="removecar2taskForms();" iconClass="delIcon" >delete</button>
					<button dojoType="dijit.form.Button" id="but3car2taskForms" jsId="but3car2taskForms" onclick="call_funUpdcar2taskForms();"  iconClass="saveIcon">save</button>
								</td>
		</tr>
	</table>			
