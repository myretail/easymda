...
<title></title>
	...
	//??¡è???????????????¨¨?¡§		
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 			...
 			<script type="text/javascript" src="../order/order2orderRowAFTab.js"></script><!--org.andromda.cartridges.bpm4struts.metafacades.StrutsManageableEntityLogicImpl[OrderRowd]-->
	 	   	 	 			<script type="text/javascript" src="../order/orderRow2orderRowTasksAFTabForSub.js"></script><!--org.andromda.cartridges.bpm4struts.metafacades.StrutsManageableEntityLogicImpl[OrderRowTask]-->
	 			<script type="text/javascript" src="../order/payment2paymentsAFTabForSub.js"></script><!--org.andromda.cartridges.bpm4struts.metafacades.StrutsManageableEntityLogicImpl[Payment]-->
	 
 
 			<!--script type="text/javascript" src="orderRow.js"></script--><!--sub Table script    eg:taskRow.js    ??????¨ª??¨ª?????¡ÀchildRow=0-->
...
//begin-------?????¡À¨ª????,??float????------------------------------------------------------------------------------------
 //???¡À????1212??layout??layoutstructure  (????layoutenumeration???????¨ª??¨ª¡ã?!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
function clickRowTab(){
									if (dijit.byId("OrderdAFTab").selectedChildWidget.id=="order2orderRow"){
					buildorder2orderRow();
																																	}else if (dijit.byId("OrderdAFTab").selectedChildWidget.id=="orderRow2orderRowTasks"){
...
<table  width="100%">
	...
	<div dojoType="dojox.layout.ExpandoPane" splitter="true" duration="125" region="bottom" title="relative data" style="height:375px;" id="bottomPane" jsId="bottomPane" >
								<table id="order2orderRowTable"  style=" position:absolute;top:0px; left:500px; width:50%;  visibility:visible;z-index:9000 ">
				<tr height="25px" width="100%">
		<td align="right" >
					...
					<button dojoType="dijit.form.myButton" onclick="downPageorder2orderRow();" id="but7order2orderRow" disabled='true' jsId="but7order2orderRow" iconClass="downPageIcon" >pagedown</button>
																											...
																											<table id="orderRow2orderRowTasksTable"  style=" position:absolute;top:0px;left:500px; width:50%; visibility:hidden ;z-index:9000">
								<tr height="25px" width="100%">
	...
	<!--td align="left"><img src="../image/imgTitle.jpg" class="imgTitleStyle" ><b>   payment2payments List</b></td-->
		<td align="right" >
				...
				<div dojoType="dijit.layout.TabContainer" style="height:100%;width:99%; position:absolute;top:8px;"   id="OrderdAFTab" jsId="OrderdAFTab"  >
						<div dojoType="dijit.layout.ContentPane" title="order2orderRow"  id="order2orderRow" jsId="order2orderRow" >
