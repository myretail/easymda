...
//have set function's manageableAssociationEnds
	...
	//
				...
				{ name: '\u8be6\u7ec6', colSpan: 5 ,styles: 'padding: 0; margin: 0;', get: getDetailPayment }//value: '<div style="height:0px; background-color: white;"></div>'
			  ]*/
		  ]
...
var addrow=[];
														addrow.push('');
																					addrow.push('');
																							if(ifMultPanepayment2payments!=undefined){
					var re=selectpayment2paymentsFunClick();
					addrow.push(re);}
						addrow.splice(0,0,false,0);
	gridPayment.addRow(addrow,gridPayment.model.getRowCount());
} 
...
//
								<tr><td align="right"  i18n="payment"  ></td>
					<td align="left" ><input  id="queryPaymentpayment"  jsId="queryPaymentpayment" class="editerInput" dojoType="dijit.form.myFilteringSelect" store="dojoPayment.paymentStore"  /></td>  
						    </tr>
...
<div dojoType="dojox.layout.ExpandoPane" splitter="true" duration="125" region="bottom" title="" style="height:375px;"  onLoad="myOnLoad" id="bottomPane" jsId="bottomPane" ><!--href="PaymentSelectTab.html"-->
								<table id="payment2paymentsTable"  style=" position:absolute;top:0px; width:90%; visibility:visible ">
				<tr height="25px" width="100%">
		<td align="right" >
					<span id="rowCountpanepayment2payments"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<button dojoType="dijit.form.myButton" onclick="upPagepanepayment2payments();"  id="but6panepayment2payments" disabled='true' jsId="but6panepayment2payments" iconClass="upPageIcon" >pageup</button>
					<button dojoType="dijit.form.myButton" onclick="downPagepanepayment2payments();" id="but7panepayment2payments" disabled='true' jsId="but7panepayment2payments" iconClass="downPageIcon" >pagedown</button>
	</td></tr></table>
						<div dojoType="dojox.layout.ContentPane" href="../common/payment2paymentsSelectPane.html"  >  </div>
	</div>
