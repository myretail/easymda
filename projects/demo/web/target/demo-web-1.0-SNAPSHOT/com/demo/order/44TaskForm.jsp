...
<title></title>
	...
	//å¤æ­æ¯å¦æ¯ä¸»è¡¨		
     ...
     <script type="text/javascript" src="../js/myi18n.js"></script>
 			...
 			<script type="text/javascript" src="../order/taskForm2tasksCrudAFTab.js"></script><!--org.andromda.cartridges.bpm4struts.metafacades.StrutsManageableEntityLogicImpl[Task]-->
	 	   			<script type="text/javascript" src="../order/orderRowTasks2taskCrudAFTabForSub.js"></script><!--org.andromda.cartridges.bpm4struts.metafacades.StrutsManageableEntityLogicImpl[OrderRowTask]-->
	 	 
 
 			<!--script type="text/javascript" src="tasks.js"></script--><!--sub Table script    eg:taskRow.js    Ð¶Ç·Îªñ³Ê¼Ó±childRow=0-->
...
//begin-------Ê¾Ñ¯Ð±ñ·,Ó´floatÚµÍ¼------------------------------------------------------------------------------------
 //Ð¶Ï±Ö¶Ç·1212ÉµlayoutÛµlayoutstructure  (Ú²Ñ¯layoutenumerationÖ¶Î²â´¦ñ¡!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	...
	gridTaskForm.resize({h: document.body.clientHeight-86});
		...
		if(connecthandle==0){
			/*handle=dojo.connect(dijit.byId("gridTaskForm"), "doclick", function(e){
				...
				mainName = querydataTaskForm[e.rowIndex][2];
...
<table  width="100%">
	<tr height="25px" width="100%">
       ...
       <div id="gridTaskForm"  dojoType="dojox.Grid" autoWidth="false"  jsId="gridTaskForm"	model="modelTaskForm"  structure="mainLayout2"  ></div>
    </div>  
	...
	<tr height="25px" width="100%">
							...
							<td align="left"><b>orderRowTasks2task List</b></td>
			<td align="right" >
						...
						<button dojoType="dijit.form.myButton" onclick="downPageorderRowTasks2task();" id="but7orderRowTasks2task" disabled='true' jsId="but7orderRowTasks2task" iconClass="downPageIcon" >pagedown</button>
																																						<button dojoType="dijit.form.myButton" onclick="saveorderRowTasks2task();"  iconClass="saveIcon" ></button>
