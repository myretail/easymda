	...
	//name =orderRowds2productCrudAFTab.js  manageable.name=OrderRowd
...
//----------move from 30.1 begin-----------
  ...
  //rowinum=10
	...
	//
		  ...
		  //(18 > 11)
			//delete2
								 ,   {name: i18nStr.customer,field: 20,get:function(inRowIndex){ var str='';var strid;if(querydataorderRowds2product[inRowIndex]!=undefined && querydataorderRowds2product[inRowIndex][20]!=undefined && querydataorderRowds2product[inRowIndex][20][1]!=undefined){str=querydataorderRowds2product[inRowIndex][20][2];strid=querydataorderRowds2product[inRowIndex][20][1];} return str+'<img src="../image/selectFloat.gif" height="16" width="16" class="imgSelectStyle"onclick="dojoOrderd.selectCustomer('+strid+','+inRowIndex+',20,0,event);"   >';} ,width: 10 }
...
function getDetailOrderd(inRowIndex){
	if(detailRowsOrderd[inRowIndex]){
		...
		var h =0;
		if(detailRowsOrderd[inRowIndex]&&querydataorderRowds2product[inRowIndex][19].length>0){
							h=65+25*querydataorderRowds2product[inRowIndex][19].length;  		}
...
function buildSubgridorderRowds2product(inRowIndex, inCell) {  //makeSubgridIdMainDetail(id)?idmainDetailGridid
	if(inCell!=undefined && inCell.getNode(inRowIndex)!=undefined){
		...
		var dataChild=querydataorderRowds2product[inRowIndex][19];
...
//ÅÐ¶Ï±¾±íÊÇ·ñÎª×Ó±í,µ±Ò»¸ö±íÊÇ¶à¸ö±íµÄ×Ó±íÊ±£¬´Ë´¦¿ÉÄÜÓÐ´íÎó¡£	
	querydataorderRowds2product=dojoOrderd.OrderdVOtoArray_fun(ul,true);
...
var buildorderRowds2product=function(){
