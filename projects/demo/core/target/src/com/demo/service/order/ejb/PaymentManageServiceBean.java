 ...
 */
public class PaymentManageServiceBean
...
{
    private com.demo.service.order.PaymentManageService paymentManageService;
    ...
    public long createPayment(com.demo.entity.order.PaymentVO Payment)
    {
        ...
        try
        {
            return this.paymentManageService.createPayment(Payment);
        }
    ...
    public void updatePayment(com.demo.entity.order.PaymentVO Payment)
    {
        ...
        try
        {
            this.paymentManageService.updatePayment(Payment);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    public void deletePayment(long id)
    {
        ...
        try
        {
            this.paymentManageService.deletePayment(id);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    public com.demo.entity.order.PaymentVO[] getPayment(com.demo.entity.order.PaymentVO Payment, int pageNumber, int pageSize, java.lang.String orderBy)
    {
        ...
        try
        {
            return this.paymentManageService.getPayment(Payment, pageNumber, pageSize, orderBy);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    {
        this.paymentManageService = (com.demo.service.order.PaymentManageService)
            getBeanFactory().getBean("paymentManageService");
    }
