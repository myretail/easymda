    ...
    implements com.demo.service.order.TaskManageService
{
    ...
    public long createTask(com.demo.entity.order.TaskVO Task)
    {
        ...
        try
        {
            return this.taskManageService.createTask(Task);
        }
    ...
    public void updateTask(com.demo.entity.order.TaskVO Task)
    {
        ...
        try
        {
            this.taskManageService.updateTask(Task);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    public void deleteTask(long id)
    {
        ...
        try
        {
            this.taskManageService.deleteTask(id);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    public com.demo.entity.order.TaskVO[] getTask(com.demo.entity.order.TaskVO Task, int pageNumber, int pageSize, java.lang.String orderBy)
    {
        ...
        try
        {
            return this.taskManageService.getTask(Task, pageNumber, pageSize, orderBy);
        }
        catch (Exception exception)
        {
            final Throwable cause = getRootCause(exception);
    ...
    {
        this.taskManageService = (com.demo.service.order.TaskManageService)
            getBeanFactory().getBean("taskManageService");
    }
