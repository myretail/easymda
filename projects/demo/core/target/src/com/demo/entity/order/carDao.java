...
public interface carDao
{
     ...
     * {@link com.demo.entity.order.carVO}.
     */
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.demo.entity.order.carVO}.
     */
    public com.demo.entity.order.carVO toCarVO(com.demo.entity.order.car entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.demo.entity.order.carVO}.
     */
    public void toCarVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.demo.entity.order.carVO}.
     */
    public com.demo.entity.order.carVO[] toCarVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.demo.entity.order.carVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.demo.entity.order.carVO} to this DAO's entity.
     */
    public com.demo.entity.order.car carVOToEntity(com.demo.entity.order.carVO carVO);

    /**
     * Converts a Collection of instances of type {@link com.demo.entity.order.carVO} to this
     * DAO's entity.
     */
    public void carVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.demo.entity.order.car from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.demo.entity.order.car}.
     *
    ...
    /**
     * Creates an instance of com.demo.entity.order.car and adds it to the persistent store.
     */
    public com.demo.entity.order.car create(com.demo.entity.order.car car);

    /**
     * <p>
     * Does the same thing as {@link #create(com.demo.entity.order.car)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.demo.entity.order.car car);

    /**
     * Creates a new instance of com.demo.entity.order.car and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.demo.entity.order.car
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.demo.entity.order.car</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(double)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Removes the instance of com.demo.entity.order.car from the persistent store.
     */
    public void remove(com.demo.entity.order.car car);

    /**
     * Removes the instance of com.demo.entity.order.car having the given
     ...
     * 
     */
    public java.util.List getcar(com.demo.entity.order.carVO car, int pageNumber, int pageSize, java.lang.String orderBy);
