...
public interface CustomerDao
{
     ...
     * {@link com.demo.entity.basic.CustomerVO}.
     */
    public final static int TRANSFORM_CUSTOMERVO = 1;

    /**
     * Copies the fields of the specified entity to the target value object. This method is similar to
     * toCustomerVO(), but it does not handle any attributes in the target
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.demo.entity.basic.CustomerVO}.
     */
    public com.demo.entity.basic.CustomerVO toCustomerVO(com.demo.entity.basic.Customer entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.demo.entity.basic.CustomerVO}.
     */
    public void toCustomerVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.demo.entity.basic.CustomerVO}.
     */
    public com.demo.entity.basic.CustomerVO[] toCustomerVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.demo.entity.basic.CustomerVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.demo.entity.basic.CustomerVO} to this DAO's entity.
     */
    public com.demo.entity.basic.Customer customerVOToEntity(com.demo.entity.basic.CustomerVO customerVO);

    /**
     * Converts a Collection of instances of type {@link com.demo.entity.basic.CustomerVO} to this
     * DAO's entity.
     */
    public void customerVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.demo.entity.basic.Customer from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.demo.entity.basic.Customer}.
     *
    ...
    /**
     * Creates an instance of com.demo.entity.basic.Customer and adds it to the persistent store.
     */
    public com.demo.entity.basic.Customer create(com.demo.entity.basic.Customer customer);

    /**
     * <p>
     * Does the same thing as {@link #create(com.demo.entity.basic.Customer)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.demo.entity.basic.Customer customer);

    /**
     * Creates a new instance of com.demo.entity.basic.Customer and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.demo.entity.basic.Customer
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.demo.entity.basic.Customer</code>
    ...
    /**
     * Updates the <code>customer</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of com.demo.entity.basic.Customer from the persistent store.
     */
    public void remove(com.demo.entity.basic.Customer customer);

    /**
     * Removes the instance of com.demo.entity.basic.Customer having the given
     ...
     * 
     */
    public java.util.List getCustomer(com.demo.entity.basic.CustomerVO Customer, int pageNumber, int pageSize, java.lang.String orderBy);
