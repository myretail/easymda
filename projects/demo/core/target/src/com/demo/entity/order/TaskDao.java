...
public interface TaskDao
{
     ...
     * {@link com.demo.entity.order.TaskVO}.
     */
    public final static int TRANSFORM_TASKVO = 1;
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.demo.entity.order.TaskVO}.
     */
    public com.demo.entity.order.TaskVO toTaskVO(com.demo.entity.order.Task entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.demo.entity.order.TaskVO}.
     */
    public void toTaskVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.demo.entity.order.TaskVO}.
     */
    public com.demo.entity.order.TaskVO[] toTaskVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.demo.entity.order.TaskVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.demo.entity.order.TaskVO} to this DAO's entity.
     */
    public com.demo.entity.order.Task taskVOToEntity(com.demo.entity.order.TaskVO taskVO);

    /**
     * Converts a Collection of instances of type {@link com.demo.entity.order.TaskVO} to this
     * DAO's entity.
     */
    public void taskVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.demo.entity.order.Task from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.demo.entity.order.Task}.
     *
    ...
    /**
     * Creates an instance of com.demo.entity.order.Task and adds it to the persistent store.
     */
    public com.demo.entity.order.Task create(com.demo.entity.order.Task task);

    /**
     * <p>
     * Does the same thing as {@link #create(com.demo.entity.order.Task)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.demo.entity.order.Task task);

    /**
     * Creates a new instance of com.demo.entity.order.Task and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.demo.entity.order.Task
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.demo.entity.order.Task</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(double, double, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(double, double)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Removes the instance of com.demo.entity.order.Task from the persistent store.
     */
    public void remove(com.demo.entity.order.Task task);

    /**
     * Removes the instance of com.demo.entity.order.Task having the given
     ...
     * 
     */
    public java.util.List getTask(com.demo.entity.order.TaskVO Task, int pageNumber, int pageSize, java.lang.String orderBy);
