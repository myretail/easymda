...
public interface TaskFormDao
{
     ...
     * {@link com.demo.entity.order.TaskFormVO}.
     */
    public final static int TRANSFORM_TASKFORMVO = 1;

    /**
     * Copies the fields of the specified entity to the target value object. This method is similar to
     * toTaskFormVO(), but it does not handle any attributes in the target
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.demo.entity.order.TaskFormVO}.
     */
    public com.demo.entity.order.TaskFormVO toTaskFormVO(com.demo.entity.order.TaskForm entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.demo.entity.order.TaskFormVO}.
     */
    public void toTaskFormVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.demo.entity.order.TaskFormVO}.
     */
    public com.demo.entity.order.TaskFormVO[] toTaskFormVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.demo.entity.order.TaskFormVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.demo.entity.order.TaskFormVO} to this DAO's entity.
     */
    public com.demo.entity.order.TaskForm taskFormVOToEntity(com.demo.entity.order.TaskFormVO taskFormVO);

    /**
     * Converts a Collection of instances of type {@link com.demo.entity.order.TaskFormVO} to this
     * DAO's entity.
     */
    public void taskFormVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.demo.entity.order.TaskForm from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.demo.entity.order.TaskForm}.
     *
    ...
    /**
     * Creates an instance of com.demo.entity.order.TaskForm and adds it to the persistent store.
     */
    public com.demo.entity.order.TaskForm create(com.demo.entity.order.TaskForm taskForm);

    /**
     * <p>
     * Does the same thing as {@link #create(com.demo.entity.order.TaskForm)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.demo.entity.order.TaskForm taskForm);

    /**
     * Creates a new instance of com.demo.entity.order.TaskForm and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.demo.entity.order.TaskForm
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.demo.entity.order.TaskForm</code>
    ...
    /**
     * Updates the <code>taskForm</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of com.demo.entity.order.TaskForm from the persistent store.
     */
    public void remove(com.demo.entity.order.TaskForm taskForm);

    /**
     * Removes the instance of com.demo.entity.order.TaskForm having the given
     ...
     * 
     */
    public java.util.List getTaskForm(com.demo.entity.order.TaskFormVO TaskForm, int pageNumber, int pageSize, java.lang.String orderBy);
