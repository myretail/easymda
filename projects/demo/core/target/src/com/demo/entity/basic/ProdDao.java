...
public interface ProdDao
{
     ...
     * {@link com.demo.entity.basic.ProdVO}.
     */
    public final static int TRANSFORM_PRODVO = 1;

    /**
     * Copies the fields of the specified entity to the target value object. This method is similar to
     * toProdVO(), but it does not handle any attributes in the target
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.demo.entity.basic.ProdVO}.
     */
    public com.demo.entity.basic.ProdVO toProdVO(com.demo.entity.basic.Prod entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.demo.entity.basic.ProdVO}.
     */
    public void toProdVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.demo.entity.basic.ProdVO}.
     */
    public com.demo.entity.basic.ProdVO[] toProdVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.demo.entity.basic.ProdVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.demo.entity.basic.ProdVO} to this DAO's entity.
     */
    public com.demo.entity.basic.Prod prodVOToEntity(com.demo.entity.basic.ProdVO prodVO);

    /**
     * Converts a Collection of instances of type {@link com.demo.entity.basic.ProdVO} to this
     * DAO's entity.
     */
    public void prodVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.demo.entity.basic.Prod from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.demo.entity.basic.Prod}.
     *
    ...
    /**
     * Creates an instance of com.demo.entity.basic.Prod and adds it to the persistent store.
     */
    public com.demo.entity.basic.Prod create(com.demo.entity.basic.Prod prod);

    /**
     * <p>
     * Does the same thing as {@link #create(com.demo.entity.basic.Prod)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.demo.entity.basic.Prod prod);

    /**
     * Creates a new instance of com.demo.entity.basic.Prod and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.demo.entity.basic.Prod
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.demo.entity.basic.Prod</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.lang.String, double, java.util.Date, java.lang.String)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>prod</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of com.demo.entity.basic.Prod from the persistent store.
     */
    public void remove(com.demo.entity.basic.Prod prod);

    /**
     * Removes the instance of com.demo.entity.basic.Prod having the given
     ...
     * 
     */
    public java.util.List getProd(com.demo.entity.basic.ProdVO Prod, int pageNumber, int pageSize, java.lang.String orderBy);
