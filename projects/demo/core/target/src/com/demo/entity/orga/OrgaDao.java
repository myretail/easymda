...
public interface OrgaDao
{
     ...
     * {@link com.demo.entity.orga.OrgaVO}.
     */
    public final static int TRANSFORM_ORGAVO = 1;

    /**
     * Copies the fields of the specified entity to the target value object. This method is similar to
     * toOrgaVO(), but it does not handle any attributes in the target
    ...
    /**
     * Converts this DAO's entity to an object of type {@link com.demo.entity.orga.OrgaVO}.
     */
    public com.demo.entity.orga.OrgaVO toOrgaVO(com.demo.entity.orga.Orga entity);

    /**
     * Converts this DAO's entity to a Collection of instances of type {@link com.demo.entity.orga.OrgaVO}.
     */
    public void toOrgaVOCollection(java.util.Collection entities);

    /**
     * Converts this DAO's entity to an array of instances of type {@link com.demo.entity.orga.OrgaVO}.
     */
    public com.demo.entity.orga.OrgaVO[] toOrgaVOArray(java.util.Collection entities);

    /**
     * Copies the fields of {@link com.demo.entity.orga.OrgaVO} to the specified entity.
    ...
    /**
     * Converts an instance of type {@link com.demo.entity.orga.OrgaVO} to this DAO's entity.
     */
    public com.demo.entity.orga.Orga orgaVOToEntity(com.demo.entity.orga.OrgaVO orgaVO);

    /**
     * Converts a Collection of instances of type {@link com.demo.entity.orga.OrgaVO} to this
     * DAO's entity.
     */
    public void orgaVOToEntityCollection(java.util.Collection instances);

    /**
     * Loads an instance of com.demo.entity.orga.Orga from the persistent store.
     */
    ...
    /**
     * Loads all entities of type {@link com.demo.entity.orga.Orga}.
     *
    ...
    /**
     * Creates an instance of com.demo.entity.orga.Orga and adds it to the persistent store.
     */
    public com.demo.entity.orga.Orga create(com.demo.entity.orga.Orga orga);

    /**
     * <p>
     * Does the same thing as {@link #create(com.demo.entity.orga.Orga)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
     ...
     * </p>
     */
    public Object create(int transform, com.demo.entity.orga.Orga orga);

    /**
     * Creates a new instance of com.demo.entity.orga.Orga and adds
     * from the passed in <code>entities</code> collection
     *
     * @param entities the collection of com.demo.entity.orga.Orga
     * instances to create.
     *
    ...
    /**
     * <p>
     * Creates a new <code>com.demo.entity.orga.Orga</code>
    ...
    /**
     * <p>
     * Does the same thing as {@link #create(java.lang.String, java.lang.String, java.lang.String, java.lang.String, long)} with an
     * additional flag called <code>transform</code>. If this flag is set to <code>TRANSFORM_NONE</code> then
     * the returned entity will <strong>NOT</strong> be transformed. If this flag is any of the other constants
     * defined here then the result <strong>WILL BE</strong> passed through an operation which can optionally
     * transform the entity (into a value object for example). By default, transformation does
    ...
    /**
     * Updates the <code>orga</code> instance in the persistent store.
     */
    ...
    /**
     * Removes the instance of com.demo.entity.orga.Orga from the persistent store.
     */
    public void remove(com.demo.entity.orga.Orga orga);

    /**
     * Removes the instance of com.demo.entity.orga.Orga having the given
     ...
     * 
     */
    public java.util.List getOrga(com.demo.entity.orga.OrgaVO Orga, int pageNumber, int pageSize, java.lang.String orderBy);
