    ...
    create table WL_CARRY_COST (
        ID BIGINT generated by default as identity (start with 1),
        START_DTE TIME not null,
        FILL_DATE TIME not null,
        FILLER VARCHAR(256) not null,
        AFFIRMER VARCHAR(256) not null,
        AFFIRM_DATE TIME not null,
    ...
    create table WL_FEE_LIST (
        ID BIGINT generated by default as identity (start with 1),
        MAKE_DATE TIME not null,
        AFFIRM_DATE TIME not null,
        START_DATE TIME not null,
        END_DATE TIME not null,
        CHARGE_DATE TIME not null,
        MANAGER_DATE TIME not null,
        APP_MANAGER_DATE TIME not null,
    ...
    create table WL_FEE_ROW (
        ...
        STATE VARCHAR(256) not null,
        INVOICE_CODE VARCHAR(256) not null,
        INVOICE_SORT VARCHAR(256) not null,
    ...
    create table WL_LOAN (
        ...
        PLAN_PAY_TIME TIME not null,
        PLAN_LOAN_FEE DOUBLE not null,
        FACT_LOAN_TIME TIME not null,
    ...
    alter table PEOPLE_RULE 
        add constraint PEOPLE_RULE_RULE_FKC 
        foreign key (RULE_FK) 
        references ROLE_INFO;

    alter table PEOPLE_RULE 
        add constraint PEOPLE_RULE_PEOPLE_FKC 
        foreign key (PEOPLE_FK) 
        references PEOPLE;
    ...
    alter table WL_ACCIDENT 
        add constraint WL_ACCIDENT_TASK_ROW_FKC 
        foreign key (TASK_ROW_FK) 
        references WL_TASK_ROW;
    ...
    alter table WL_LOAN 
        add constraint WL_LOAN_TASK_ROW_FKC 
        foreign key (TASK_ROW_FK) 
        references WL_TASK_ROW;
    ...
    alter table WL_ORDER_QUOTATION 
        add constraint WL_ORDER_QUOTATION_ORDER_FKC 
        foreign key (ORDER_FK) 
        references WL_ORDER;
    ...
    alter table WL_PEOPLE_COST 
        add constraint WL_PEOPLE_COST_VOITURE_FKC 
        foreign key (VOITURE_FK) 
        references WL_VOITURE;
    ...
    alter table WZ_FETCH_FORM 
        ...
        foreign key (PEOPLE_FK) 
        references PEOPLE;
 select * from PEOPLE_ROLE inner join PEOPLE  on PEOPLE_ROLE.PEOPLE_FK=PEOPLE.ID where PEOPLE.ID=1
alter  table customer  add column cust_Enum  VARCHAR(256);