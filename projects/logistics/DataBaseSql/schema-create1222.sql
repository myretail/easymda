    ...
    create table WL_ORDER (ID BIGINT generated by default as identity (start with 1),        CUSTOMER_ORDER_NO VARCHAR(256),        CONTRACT_NO VARCHAR(256),        CONVEYANCE VARCHAR(256) not null,        CARRY_TYPE VARCHAR(256),        SHIPPER_REMARK VARCHAR(256),        CARRIER_REMARK VARCHAR(256),        WLLEVEL VARCHAR(256),        CUSTOMER_TYPE VARCHAR(256) not null,        REFER_TIME DATETIME not null,        LINK_MAN VARCHAR(256),        TEL VARCHAR(256),        BOOK_TIME DATETIME,        COMPLETE_TIME DATETIME,        FORM_STATE VARCHAR(256) not null,        PLAN_FETCH_TIME DATETIME,        FETCH_COMPANY_NAME VARCHAR(256),        FETCH_COMPANY_ADDRESS VARCHAR(256),        FETCH_MAN VARCHAR(256),        FETCH_TEL VARCHAR(256),        PLAN_UNLOAD_TIME DATETIME,        UNLOAD_COMPANY_NAME VARCHAR(256),        UNLOAD_COMPANY_ADDRESS VARCHAR(256),        UNLOAD_MAN VARCHAR(256),        UNLOAD_TEL VARCHAR(256),        REMARK VARCHAR(256),        PAY_COMPANY_FK BIGINT not null,        FETCH_COMPANY_FK BIGINT not null,        UNLOAD_COMPANY_FK BIGINT not null,        CUSTOMER_FK BIGINT not null,        BOOKER_FK BIGINT not null,        WLOPERATOR_FK BIGINT not null,        TASK_PEOPLE_FK BIGINT not null,        PATH_FK BIGINT not null,        primary key (ID)    );
    ...
    create table WL_TASK (
        ...
        OVER_TIME DATETIME,
        REMARK VARCHAR(256),
        DRIVER_TEL VARCHAR(256),
        FOLLOWER VARCHAR(256),
        MANAGER_FK BIGINT not null,
        VOITURE_FK BIGINT not null,
        ASSIST_DRIVER_FK BIGINT,
        MASTER_DRIVER_FK BIGINT,
        primary key (ID)
    );
    ...
    alter table WL_TASK 
        add constraint WL_TASK_VOITURE_FKC 
        foreign key (VOITURE_FK) 
        references WL_VOITURE;
    ...
    alter table WL_TASK 
        add constraint WL_TASK_MASTER_DRIVER_FKC 
        foreign key (MASTER_DRIVER_FK) 
        references PEOPLE;

    alter table WL_TASK 
        add constraint WL_TASK_ASSIST_DRIVER_FKC 
